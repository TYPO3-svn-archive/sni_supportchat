...
t3lib_extMgm::allowTableOnStandardPages("tx_snisupportchat_internal_messages");

$TCA["tx_snisupportchat_internal_messages"] = Array (
	"ctrl" => Array (
		'title' => 'LLL:EXT:sni_supportchat/locallang_db.xml:tx_snisupportchat_internal_messages',		
		'label' => 'from_be_user',	
		'tstamp' => 'tstamp',
		'crdate' => 'crdate',
		'cruser_id' => 'cruser_id',
	...
	"feInterface" => Array (
		"fe_admin_fieldList" => "chat, from_be_user, to_be_user, message",
	)
);
...
// t3lib_extMgm::addStaticFile($_EXTKEY,"pi1/static/","Support Chat");
