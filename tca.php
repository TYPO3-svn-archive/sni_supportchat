...
$TCA["tx_snisupportchat_internal_messages"] = Array (
	"ctrl" => $TCA["tx_snisupportchat_internal_messages"]["ctrl"],
	"interface" => Array (
		"showRecordFieldList" => "chat,from_be_user,to_be_user,message"
	),
	"feInterface" => $TCA["tx_snisupportchat_internal_messages"]["feInterface"],
	"columns" => Array (
		"chat" => Array (		
			"exclude" => 1,		
			"label" => "LLL:EXT:sni_supportchat/locallang_db.xml:tx_snisupportchat_internal_messages.chat",		
			"config" => Array (
				"type" => "group",	
				"internal_type" => "db",	
				"allowed" => "tx_snisupportchat_chats",	
		...
		"from_be_user" => Array (		
			"exclude" => 1,		
			"label" => "LLL:EXT:sni_supportchat/locallang_db.xml:tx_snisupportchat_internal_messages.from_be_user",		
			"config" => Array (
				"type" => "group",	
				"internal_type" => "db",	
				"allowed" => "be_users",	
		...
		"to_be_user" => Array (		
			"exclude" => 1,		
			"label" => "LLL:EXT:sni_supportchat/locallang_db.xml:tx_snisupportchat_internal_messages.to_be_user",		
			"config" => Array (
				"type" => "group",	
				"internal_type" => "db",	
				"allowed" => "be_users",	
		...
		"message" => Array (		
			"exclude" => 1,		
			"label" => "LLL:EXT:sni_supportchat/locallang_db.xml:tx_snisupportchat_internal_messages.message",		
			"config" => Array (
				"type" => "text",
				"wrap" => "OFF",
				"cols" => "30",	
		...
		"active" => Array (		
			"exclude" => 1,		
			"label" => "LLL:EXT:sni_supportchat/locallang_db.xml:tx_snisupportchat_internal_messages.active",		
			"config" => Array (
				"type" => "check",
			)
		),	
		"to_do" => Array (		
			"exclude" => 1,		
			"label" => "LLL:EXT:sni_supportchat/locallang_db.xml:tx_snisupportchat_internal_messages.to_do",		
			"config" => Array (
				"type" => "input",	
				"size" => "30",
			)
	...
	"types" => Array (
		"0" => Array("showitem" => "chat;;;;1-1-1, from_be_user, to_be_user, message")
	),
	"palettes" => Array (
		"1" => Array("showitem" => "")
	)
